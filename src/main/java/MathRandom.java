...
public class MathRandom {
     ...
     * 0出现的概率为%40
     */
    public static double  EVENT_TYPE_TAP = 0.55;
    /**
     * 1出现的概率为%30
     */
    public static double EVENT_TYPE_SWIPE = 0.20;
    /**
     * 2出现的概率为%10
     */
    public static double EVENT_TYPE_BACK = 0.15;

    public static double EVENT_TYPE_SUBMIT = 0.05;

    public static double EVENT_TYPE_CONTENT = 0.00;
